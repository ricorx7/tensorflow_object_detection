...
# Find all the images in the folder video_output
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    ...
    for image_path in TEST_IMAGE_PATHS:
      ...
      #plt.imshow(image_np)
      #plt.show()
      #plt.image.imsave(PATH_TO_OUTPUT_IMAGES_DIR + "/" + str(img_idx) + ".jpg", image_np)
      #plt.savefig(PATH_TO_OUTPUT_IMAGES_DIR + "/" + str(img_idx) + ".jpg")
